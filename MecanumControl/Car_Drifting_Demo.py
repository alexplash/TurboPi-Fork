...
print('''
**********************************************************
*******************功能:小车漂移移动例程(function: car drifting movement routine)**********************
**********************************************************
----------------------------------------------------------
...
if __name__ == '__main__':
    while start:
        chassis.set_velocity(50,180,0.3) # 控制机器人移动函数,线速度50(0~100)，方向角180(0~360)，偏航角速度0.3(-2~2)(robot motion control function, linear velocity 50(0~100), heading angle 180(0~360), yaw rate 0.3(-2~2))
        time.sleep(3)
