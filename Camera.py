...
class Camera:
    ...
    def camera_task(self):
        while True:
            try:
                if not self.opened or not self.cap.isOpened():
                    time.sleep(0.01)
                    continue
